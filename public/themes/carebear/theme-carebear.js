...
function createItems() {
    ...
    files.forEach((file, index) => {
        ...
        item.style.setProperty("--item-width", `${rand(145, 205)}px`);
        item.style.setProperty("--item-rotate", `${rand(-8, 8)}deg`);
        item.style.setProperty("--item-scale", rand(0.90, 1.03).toFixed(2));
