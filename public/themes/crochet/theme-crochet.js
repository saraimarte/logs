...
const THEME_ID = "crochet";
const THEME_SVGS = ["<svg viewBox=\"0 0 110 110\" xmlns=\"http://www.w3.org/2000/svg\"><circle cx=\"52\" cy=\"54\" r=\"38\" fill=\"#d487aa\" stroke=\"currentColor\" stroke-width=\"4\"/><path d=\"M25 44 Q52 22 78 42 M22 61 Q48 38 82 58 M30 78 Q53 56 76 74\" fill=\"none\" stroke=\"#f4c8dc\" stroke-width=\"5\"/><path d=\"M79 77 Q96 88 99 101\" fill=\"none\" stroke=\"#d487aa\" stroke-width=\"5\"/></svg>", "<svg viewBox=\"0 0 100 120\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M62 12 Q75 18 69 31 L46 81 Q38 102 53 108 Q68 112 78 96\" fill=\"none\" stroke=\"#caa66c\" stroke-width=\"9\" stroke-linecap=\"round\"/><path d=\"M66 13 L78 18\" stroke=\"currentColor\" stroke-width=\"4\"/></svg>", "<svg viewBox=\"0 0 110 110\" xmlns=\"http://www.w3.org/2000/svg\"><rect x=\"12\" y=\"12\" width=\"86\" height=\"86\" rx=\"12\" fill=\"#f7e4ef\" stroke=\"currentColor\" stroke-width=\"4\"/><rect x=\"27\" y=\"27\" width=\"56\" height=\"56\" rx=\"10\" fill=\"#92b69a\"/><rect x=\"41\" y=\"41\" width=\"28\" height=\"28\" rx=\"7\" fill=\"#e6b061\"/><circle cx=\"55\" cy=\"55\" r=\"7\" fill=\"#d57a9e\"/></svg>", "<svg viewBox=\"0 0 100 100\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M50 88 C18 66 12 44 25 30 C36 18 48 25 50 37 C52 25 64 18 75 30 C88 44 82 66 50 88Z\" fill=\"#d5809f\" stroke=\"currentColor\" stroke-width=\"4\"/></svg>"];
const THEME_NOTES = [220, 277.18, 329.63, 415.3];
const SOUND_STYLE = "soft";
    ...
    themeMouseHandler = (event) => {
        ...
        themeItems.forEach((obj, index) => {
            ...
            if (Math.hypot(cx-event.clientX, cy-event.clientY) <= radius &&
                ...
                obj.last = now;
                lastGlobalSound = now;
                obj.el.classList.remove("theme-crochet-react");
                void obj.el.offsetWidth;
                obj.el.classList.add("theme-crochet-react");
                playThemeSound(obj.note, index);
                setTimeout(() => obj.el.classList.remove("theme-crochet-react"), 520);
            }
        });
    };
...
export function mount() {
    ...
    themeStylesheet.href = "/themes/theme-crochet.css";
    themeStylesheet.dataset.theme = "crochet";
    document.head.appendChild(themeStylesheet);

    themeBackground = document.createElement("div");
    themeBackground.id = "crochet-background";
