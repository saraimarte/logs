...
const THEME_ID = "volcano";
const THEME_SVGS = ["<svg viewBox=\"0 0 140 120\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M20 105 L55 38 H85 L120 105Z\" fill=\"#5a3127\" stroke=\"currentColor\" stroke-width=\"4\"/><path d=\"M55 38 Q70 50 85 38 L79 58 Q70 68 61 58Z\" fill=\"#ef5a32\"/><path d=\"M68 37 Q58 18 67 10 M77 38 Q88 18 79 8\" fill=\"none\" stroke=\"#f0a340\" stroke-width=\"6\" stroke-linecap=\"round\"/></svg>", "<svg viewBox=\"0 0 100 110\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M22 12 H78 V82 Q75 103 60 84 Q50 108 40 84 Q25 103 22 82Z\" fill=\"#ec4f2c\" stroke=\"currentColor\" stroke-width=\"4\"/><path d=\"M34 18 V60 M52 18 V76 M68 18 V52\" stroke=\"#f6b047\" stroke-width=\"7\" stroke-linecap=\"round\"/></svg>", "<svg viewBox=\"0 0 110 90\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M15 72 L25 33 L51 14 L88 27 L101 65 L75 82 L35 80Z\" fill=\"#60443d\" stroke=\"currentColor\" stroke-width=\"4\"/><path d=\"M34 35 L52 27 L74 38\" fill=\"none\" stroke=\"#8d6254\" stroke-width=\"4\"/></svg>", "<svg viewBox=\"0 0 100 120\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M48 105 Q28 88 43 70 Q18 53 40 38 Q30 20 50 10 Q75 19 61 39 Q82 54 59 72 Q76 91 48 105Z\" fill=\"#8b8585\" opacity=\".7\" stroke=\"currentColor\" stroke-width=\"3\"/></svg>"];
const THEME_NOTES = [82.41, 98, 123.47, 146.83];
const SOUND_STYLE = "rumble";
    ...
    themeMouseHandler = (event) => {
        ...
        themeItems.forEach((obj, index) => {
            ...
            if (Math.hypot(cx-event.clientX, cy-event.clientY) <= radius &&
                ...
                obj.last = now;
                lastGlobalSound = now;
                obj.el.classList.remove("theme-volcano-react");
                void obj.el.offsetWidth;
                obj.el.classList.add("theme-volcano-react");
                playThemeSound(obj.note, index);
                setTimeout(() => obj.el.classList.remove("theme-volcano-react"), 520);
            }
        });
    };
...
export function mount() {
    ...
    themeStylesheet.href = "/themes/theme-volcano.css";
    themeStylesheet.dataset.theme = "volcano";
    document.head.appendChild(themeStylesheet);

    themeBackground = document.createElement("div");
    themeBackground.id = "volcano-background";
