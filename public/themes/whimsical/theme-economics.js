...
const THEME_SVGS = ["<svg viewBox=\"0 0 140 80\" xmlns=\"http://www.w3.org/2000/svg\"><text x=\"10\" y=\"54\" font-size=\"42\" font-family=\"monospace\" font-weight=\"700\" fill=\"currentColor\">x\u00b2+3=12</text></svg>", "<svg viewBox=\"0 0 110 110\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M16 95V15 M16 95H100\" stroke=\"currentColor\" stroke-width=\"4\"/><path d=\"M22 85 Q45 78 56 58 Q73 27 96 22\" fill=\"none\" stroke=\"#6688c8\" stroke-width=\"6\"/><circle cx=\"56\" cy=\"58\" r=\"5\" fill=\"#bd6e9c\"/></svg>", "<svg viewBox=\"0 0 100 100\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M50 12 L86 31 L86 70 L50 90 L14 70 L14 31Z\" fill=\"#dbe5f7\" stroke=\"currentColor\" stroke-width=\"4\"/><path d=\"M50 12V52 M14 31L50 52L86 31 M50 52V90\" fill=\"none\" stroke=\"#6688c8\" stroke-width=\"4\"/></svg>", "<svg viewBox=\"0 0 100 100\" xmlns=\"http://www.w3.org/2000/svg\"><text x=\"22\" y=\"75\" font-size=\"74\" font-family=\"serif\" font-weight=\"700\" fill=\"currentColor\">\u03c0</text></svg>"];
    ...
    themeMouseHandler = (event) => {
        ...
        themeItems.forEach((obj, index) => {
            ...
            if (Math.hypot(cx-event.clientX, cy-event.clientY) <= radius &&
                ...
                setTimeout(() => obj.el.classList.remove("theme-algebra-react"), 520);
            }
        });
    };
