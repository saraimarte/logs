...
const THEME_ID = "library";
const THEME_SVGS = ["<svg viewBox=\"0 0 120 90\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M12 15 Q38 10 57 24 V79 Q38 66 12 72Z\" fill=\"#f1e5cc\" stroke=\"currentColor\" stroke-width=\"4\"/><path d=\"M108 15 Q82 10 63 24 V79 Q82 66 108 72Z\" fill=\"#f1e5cc\" stroke=\"currentColor\" stroke-width=\"4\"/><path d=\"M60 22V80\" stroke=\"#a36140\" stroke-width=\"4\"/></svg>", "<svg viewBox=\"0 0 100 120\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M28 50 Q50 13 72 50Z\" fill=\"#d3ab5e\" stroke=\"currentColor\" stroke-width=\"4\"/><path d=\"M50 50V100 M32 105H68\" stroke=\"#6f513d\" stroke-width=\"6\" stroke-linecap=\"round\"/></svg>", "<svg viewBox=\"0 0 130 100\" xmlns=\"http://www.w3.org/2000/svg\"><rect x=\"10\" y=\"18\" width=\"110\" height=\"64\" rx=\"6\" fill=\"#5e3d2d\" stroke=\"currentColor\" stroke-width=\"4\"/><g fill=\"#b36249\"><rect x=\"20\" y=\"29\" width=\"13\" height=\"42\"/><rect x=\"37\" y=\"23\" width=\"14\" height=\"48\" fill=\"#6e7a57\"/><rect x=\"55\" y=\"32\" width=\"12\" height=\"39\" fill=\"#c2a15d\"/><rect x=\"71\" y=\"26\" width=\"15\" height=\"45\" fill=\"#7f5b8d\"/><rect x=\"90\" y=\"30\" width=\"16\" height=\"41\" fill=\"#58748a\"/></g></svg>", "<svg viewBox=\"0 0 100 120\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M78 12 Q40 21 24 77 Q47 69 66 51 Q78 39 78 12Z\" fill=\"#d7c39c\" stroke=\"currentColor\" stroke-width=\"4\"/><path d=\"M22 101 Q42 65 72 25\" fill=\"none\" stroke=\"#7a563f\" stroke-width=\"5\"/></svg>"];
const THEME_NOTES = [196, 246.94, 293.66, 392];
const SOUND_STYLE = "page";
    ...
    themeMouseHandler = (event) => {
        ...
        themeItems.forEach((obj, index) => {
            ...
            if (Math.hypot(cx-event.clientX, cy-event.clientY) <= radius &&
                ...
                obj.last = now;
                lastGlobalSound = now;
                obj.el.classList.remove("theme-library-react");
                void obj.el.offsetWidth;
                obj.el.classList.add("theme-library-react");
                playThemeSound(obj.note, index);
                setTimeout(() => obj.el.classList.remove("theme-library-react"), 520);
            }
        });
    };
...
export function mount() {
    ...
    themeStylesheet.href = "/themes/theme-library.css";
    themeStylesheet.dataset.theme = "library";
    document.head.appendChild(themeStylesheet);

    themeBackground = document.createElement("div");
    themeBackground.id = "library-background";
