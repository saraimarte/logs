...
const THEME_NAME = "walkingdead";
const ASSET_ROOTS = [
    "/svg/theme-walkingdead/"
];
const ASSET_FILES = [
    "theme-walkingdead-01.svg",
    "theme-walkingdead-02.svg",
    "theme-walkingdead-03.svg",
    "theme-walkingdead-04.svg",
    "theme-walkingdead-05.svg",
    "theme-walkingdead-06.svg",
    "theme-walkingdead-07.svg",
    "theme-walkingdead-08.svg",
    "theme-walkingdead-09.svg",
    "theme-walkingdead-10.svg",
    "theme-walkingdead-11.svg",
    "theme-walkingdead-12.svg",
    "theme-walkingdead-13.svg",
    "theme-walkingdead-14.svg"
];
const HOVER_SOUNDS = [
    "/sounds/abc/freesound_community-card-sounds-35956.mp3",
    "/sounds/abc/freesound_community-papier-fouilles-23558.mp3"
];
const HOVER_VOLUME = 0.34;
const INTRO_CONFIG = {
    "sources": [
        "/sounds/intros/lazarosv-whispers-in-the-shadows-246968.mp3"
    ],
    "full": true,
    "fade_end": true,
    "volume": 0.24
...
function createItems() {
    ...
    files.forEach((file, index) => {
        ...
        item.style.top = `${slot.y + rand(-1.6, 1.6)}%`;
        item.style.setProperty("--item-width", `${rand(170, 255)}px`);
